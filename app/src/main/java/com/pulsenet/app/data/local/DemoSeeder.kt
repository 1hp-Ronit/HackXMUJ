...
class DemoSeeder @Inject constructor(
    ...
    private fun buildDemoMessages(): List<MessageEntity> {
        ...
        val templates = listOf(
            ...
            Template("Fire spreading near the main gate, evacuate immediately", 0, "Karan"),
            Template("मेरी माँ बेहोश हैं, please help urgent", 0, "Simran"),
            Template("Broken arm, in a lot of pain, near library building", 1, "Vikram"),
            Template("Need ambulance for elderly person, difficulty breathing", 1, "Neha"),
            Template("Hurt my leg trying to climb over rubble, can walk slowly", 1, "Aditya"),
            Template("Medical help needed for pregnant woman", 1, "Kavya"),
            ...
            Template("Have extra blankets and food to share", 2, "Meera"),
            Template("Baby needs formula milk, anyone have spare?", 2, "Sanya"),
            Template("Khana aur pani chahiye, 5 log hain humare group mein", 2, "Farhan"),
            Template("Medicine for diabetes needed, anyone carrying insulin?", 2, "Ishaan"),
            ...
            Template("Phone battery low, will check in again in an hour", 3, "Pooja"),
            ...
            Template("Does anyone have a working power bank to share?", 3, "Manav"),
        ...
        repeat(2) { round ->
            templates.forEachIndexed { index, template ->
                val globalIndex = round * templates.size + index
                ...
                val alias = if (round == 0) template.alias else "${template.alias} Jr"

                messages += MessageEntity(
                    messageId = "seed-$globalIndex-${random.nextInt(100_000, 999_999)}",
                    senderPublicKey = "seed-public-key-$globalIndex",
                    senderAlias = alias,
